...
const budget = [
  ...
  { file: "open-sse/executors/antigravity/credits-retry.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/execute-loop.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/executor.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/header-builder.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/project-onboarding.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/project-resolver.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/rate-limit-flow.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/request-content.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/request-transform.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/retry-policy.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/sse-stream.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/stream-collector.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/token-refresh.ts", maxAny: 0 },
  { file: "open-sse/executors/antigravity/types.ts", maxAny: 0 },
