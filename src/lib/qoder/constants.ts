...
// Model identifiers are NOT hard-coded. The live catalog
// (open-sse/services/qoderModels.ts → /algo/api/v2/model/list) is the
// source of truth — server publishes per-account keys (e.g. "qmodel_latest"
// for Qwen 3.7 Max) and the set evolves over time. Executor accepts any
// key that appears in the live catalog response.
//
// For UI fallback before the user connects, see QODER_STATIC_MODELS in
