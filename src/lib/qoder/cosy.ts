...
function encryptUserInfo(userInfo: QoderUserInfoBlob): { cosyKey: string; info: string } {
 ...
 *
 * @param body  The exact bytes that will be sent. For GET requests pass an empty Buffer / "".
 * @param requestUrl Full request URL (used for sigPath).
 * @param creds COSY credentials (userId/authToken required, machineId persisted).
 */
