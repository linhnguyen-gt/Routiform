...
const config = {
	...
	kit: {
		...
		// ROUTIFORM PATCH — the app is mounted at /owui inside the Next.js host, so its own
		// assets (/_app/...) have to resolve there too. Without this, index.html asks for
		// /_app/... at the root and Next.js answers with its own 404 page.
		paths: {
			base: '/owui'
		},
